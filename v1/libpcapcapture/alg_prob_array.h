...
typedef struct parray_s {
    ...
    unsigned long long** card; // over 1000000
    unsigned int* card_hash, *card_scale, *card_hardner;

    //qhuang: just to evaluates
...
// 0: non-exist, ret is the samllest one
...
// int parray_delete(parray_t* array, tuple_t* t);
